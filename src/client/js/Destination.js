const Destination = `
<section class="c-destination__header">
<img data-block="widget-img" class="c-destination__image" src="http://localhost:3000/images/placehoder-img.svg" alt="Destination image">
<div class="c-destination__info">
<div class="c-destination__location">
...
<p data-block="capsule-view" data-input-name="location" tabindex="0" data-input-label="Destination location" data-placeholder="Destination location" class="c-capsule__view h-empty" aria-description="Click or press Enter to edit"></p>
...
<time data-block="capsule-view" data-input-name="start_date" tabindex="0" data-input-label="Destination start date" data-placeholder="Start date" class="c-capsule__view h-empty" aria-description="Click or press Enter to edit"></time>
</span>
<span>&#8212</span>
<span data-block="capsule" class="c-date__end c-capsule">
<time data-block="capsule-view" data-input-name="end_date" tabindex="0" data-input-label="Destination end date" data-placeholder="End date" class="c-capsule__view h-empty" aria-description="Click or press Enter to edit"></time>
</span>
</div>
</div>
</div>
<div class="c-destination__controls">
...
<button data-block="controls-close" class="c-controls__close">
<span class="c-controls__icon">
...
<section data-control="target" class="c-destination__body">
<div class="c-destination__widgets">
